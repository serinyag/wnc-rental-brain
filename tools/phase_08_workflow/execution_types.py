...
EXECUTION_FAILURE_OUTLOOK_DRAFT_CHANGED_AFTER_APPROVAL = "outlook_draft_changed_after_approval"
EXECUTION_FAILURE_OUTLOOK_SEND_GOVERNANCE_INVALID = "outlook_send_governance_invalid"
